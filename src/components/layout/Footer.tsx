...
const Footer = () => (
  <footer className="p-6 lg:p-12 text-yellow1 bg-darkblue1">
    ...
    <div className="flex flex-col w-full max-w-64">
      <p className="font-secondary md:mb-4 text-xl lg:text-[2.5rem] font-black uppercase tracking-wider">Seastemik</p>
    ...
    <div className="flex flex-col w-full max-w-64">
      <p className="font-secondary md:mb-4 text-xl lg:text-[2.5rem] font-black uppercase tracking-wider">Data for Good</p>
