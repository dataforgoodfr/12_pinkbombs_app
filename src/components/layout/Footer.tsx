    ...
    <div className="max-w-[1500px] mx-auto">
      <div className="flex flex-wrap gap-6 lg:gap-12 lg:pt-12">
        <div className="flex flex-col w-full max-w-72">
          <p className="font-secondary md:mb-4 text-xl lg:text-[2.5rem] font-black uppercase tracking-widest">Seastemik</p>
        ...
        <div className="flex flex-col w-full max-w-72">
          <p className="font-secondary md:mb-4 text-xl lg:text-[2.5rem] font-black uppercase tracking-widest">Data for Good</p>
