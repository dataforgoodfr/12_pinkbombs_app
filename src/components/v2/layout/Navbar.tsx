...
const Navbar = () => {
  ...
  const getBackgroundColor = () => getSectionBackgroundClass(pathname);
  const getColor = () => getSectionColor(pathname);
  ...
  return (
    ...
    >
      <div className="flex flex-wrap items-center justify-between gap-6 px-6 lg:px-12 py-3 lg:py-6 max-w-[1596px] mx-auto">
        ...
        <nav
          className="hidden lg:flex flex-wrap gap-4 lg:gap-10 ml-auto"
                ...
                <div className="inline-block self-center mr-2">
                  ...
                  >
                    <path
                      className={`${
                        getColor() === "blue"
                          ? "fill-v2-blue group-hover:fill-v2-magenta"
                          : "fill-v2-pink group-hover:fill-v2-magenta"
      ...
      >
        <div
          aria-hidden="true"
          className="fixed inset-0 bg-black/30 transition data-closed:opacity-0 data-enter:duration-200 data-enter:ease-out data-leave:duration-150 data-leave:ease-in"
        />
